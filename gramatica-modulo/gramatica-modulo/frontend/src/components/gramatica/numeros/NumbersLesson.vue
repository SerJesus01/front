...
const objetivoFormateado = computed(() => objetivo.value === null ? '' : new Intl.NumberFormat('es-MX').format(objetivo.value));
  ...
  <section class="numbers-lesson">
    ...
    <template v-if="leccion === 1">
      ...
      <section class="place-value">
        ...
        <p v-if="objetivo !== null" class="place-value__target">Armá el número <strong>{{ objetivoFormateado }}</strong></p>
